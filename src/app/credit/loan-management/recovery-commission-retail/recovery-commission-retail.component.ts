...
export class RecoveryCommissionRetailComponent implements OnInit {
  ...
  getAllLoansOperationRecoveryAnalysisByAgent() {
    ...
    this.loanOperationService.getAllLoansForExternalRecoveryAnalysisByAgent(this.source).subscribe((response:any) => {
  ...
  getAllRecoveryCommissonByAgents() {
    this.loadingService.show();
    this.loanOperationService.getAllRecoveryCommissonByAgents().subscribe((response:any) => {
  ...
  computeComission(){
    ...
    if(amoutRecovered < 10000000){
      const commission = (amoutRecovered*0.1).toFixed(2);
      this.recoveryCommissionForm.controls['commissionRate'].setValue("10");
      this.recoveryCommissionForm.controls['commissionPayable'].setValue(commission);
    }
    if(amoutRecovered >= 10000000){
      const commission = (amoutRecovered*0.07).toFixed(2);
      this.recoveryCommissionForm.controls['commissionRate'].setValue("7");
      this.recoveryCommissionForm.controls['commissionPayable'].setValue(commission);
    }
  }
