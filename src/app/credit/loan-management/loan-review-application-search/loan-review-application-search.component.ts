  ...
  saveLoanApplicationCancellation()
  {
    ...
    let __this = this;
      ...
      swal({
          ...
          __this.loanService.loanApplicationLmsCancellationRequest(body).subscribe((response:any) => {
...
getDocumentationSections(showLoadDocumentModal: boolean) {
    this.loadingService.show();
    this.subscriptions.add(
    this.camService.getDocumentSections(this.APPRAISAL_OPERATION_ID, this.application.loanApplicationId).subscribe((response:any) => {
...
onDocumentSectionChange(sectionId) {
    this.loadingService.show();
    this.subscriptions.add(
    this.camService.getDocumentSection(this.APPRAISAL_OPERATION_ID, this.application.loanApplicationId, sectionId).subscribe((response:any) => {
...
closeDocumentation() {
  ...
  previewDocumentation(print = false) {
    this.loadingService.show();
    this.camService.getDocumentation(this.APPRAISAL_OPERATION_ID, this.application.loanApplicationId).subscribe((response:any) => {
...
//   }
  ...
  previewDocumentationLOS(print=false) {
    this.loadingService.show();
    this.camService.getDocumentation(this.OPERATION_ID, this.application.creditAppraisalLoanApplicationId).subscribe((response:any) => {
        this.documentations = response.result;
        this.loadingService.hide();
        if (print == false) this.displayDocumentation = true;
        //else setTimeout(() => this.print2222(), 1000);
