...
import { ApprovalGroupRole, ApprovalStatus, GlobalConfig, IntegratedCustomerTypeEnum, JobSource, ProductClassProcessEnum } from 'app/shared/constant/app.constant';
import { WorkflowTarget } from 'app/shared/models/workflow-target';
import values from 'assets/config/values';
import { fromEvent, Subject } from 'rxjs';
import { CreditAppraisalService, LoanApplicationService, LoanService } from '../services';
import { ConditionPrecedentService, CurrencyService, ProductService, StaffRealTimeSearchService, StaffRoleService } from 'app/setup/services';
...
@Component({
  selector: 'app-cashflow-document-review',
  templateUrl: './cashflow-document-review.component.html',
  styleUrls: ['./cashflow-document-review.component.scss']
})
export class CashflowDocumentReviewComponent implements OnInit {
  customerId: any;
  ...
  //=========================================
  readonly OPERATION_ID: number = 288; 
  ...
  getLoanApplications(
      ...
      search: boolean = false
          ...
          this.loadingService.show();
          this.camService.getCashFlowForReview(this.OPERATION_ID, page, itemsPerPage, classId, this.searchString, this.isPoolRequest).subscribe((response:any) => {
